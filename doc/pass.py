...
def _should_validate_type_vendor_change(request_data: Dict[str, Any] | None) -> bool:
    """ES 系统校验 TYPE / VENDOR 图块属性变更；FAB1 / FAB2 厂区跳过。"""
    return not _skip_type_vendor_validation(request_data)

...
async def write_fid(
    ...
    """fid 图纸数据回填：默认按 filePath 从 FTP 下载 DXF；若提供 localDxfPath 则读本地文件。结果上传至 EFMS/fid_with_assignment/…"""
    ...
    def sync_write_fid():
        try:
            ...
            _, rel_path = build_write_fid_ftp_result_names(src_stem)
            ...
            logger.info(
                ...
                f"ftp_dst={rel_path}, cleared_equ={cleared}, assigned={assigned_count}, "
